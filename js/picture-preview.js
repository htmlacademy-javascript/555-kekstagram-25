...
usersPhoto.forEach(({url, likes, comments}) => { //превращение параметров объектов в переменные
  ...
  photoPreviewElement.querySelector('.picture__comments').textContent = comments.length; //количество комментариев comments выводится в блок .picture__comments
